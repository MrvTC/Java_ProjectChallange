...
public class MusteriVeArabaBilgisiGirisi extends AracTalebi {
    ...
    public static void aracTalep() {
        ...
        System.out.println("************************************");
        if (intAAy>intTAy || intAGunu>intTGunu ) {
    ...
    public static void arabalar() {
        ...
        //AracTalebi aracTalebi=new AracTalebi();
        ...
        aracTalebiList.add(opelDizelOtomatik);aracTalebiList.add(opelDizelManuel);aracTalebiList.add(opelBenzinliOtomatik);
        aracTalebiList.add(opelBenzinliManuel);aracTalebiList.add(toyotaDizelOtomatik);aracTalebiList.add(toyotaDizelManuel);
        aracTalebiList.add(toyotaBenzinliOtomatik);aracTalebiList.add(toyotaBenzinliManuel);aracTalebiList.add(vwDizelOtomatik);
        aracTalebiList.add(vwDizelManuel);aracTalebiList.add(vwBenzinliOtomatik);aracTalebiList.add(vwBenzinliManuel);
